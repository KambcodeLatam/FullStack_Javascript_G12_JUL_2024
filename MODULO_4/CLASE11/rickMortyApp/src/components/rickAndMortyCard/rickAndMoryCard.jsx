     ...
     <div className="card m-10">
        {
            search.filter((item) => {
                ...
                return <CharacterCard key={data.id} img={data.image} genre={data.species} status={data.status} name={data.name}/>
...
export default RickAndMoryCard