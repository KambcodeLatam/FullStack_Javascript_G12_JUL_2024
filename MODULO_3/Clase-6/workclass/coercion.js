...
console.log('sadsad' * 'aeiou'); // NaN
console.log('sadsad' + 'aeiou'); // 'sadsadaeiou' string
...
console.log(Boolean(-5)); // true
console.log(Boolean('-5')); // true
console.log(Boolean('sdfsdfsdfsdf')); // true
...
console.log(Number('11')); // 11 number
console.log(Number('dfgdgdfg')); // NaN
